...
const FlowBar = () => {
    return (
        <>
            <div className='shadow-lg w-[450px] h-16 rounded-2xl border-2 text-[#747474] font-Poppins font-medium border-border-gray flex items-center justify-center text-left'>
                <h2 className="">Your Mibu Flow</h2>
                <svg className="ml-4" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
